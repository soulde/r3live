...
int main(int argc, char **argv) {
    ...
    auto node = std::make_shared<LidarFrontEnd>();
    rclcpp::spin(node);
    rclcpp::shutdown();
    return 0;
}
...
void LidarFrontEnd::mid_handler(const sensor_msgs::msg::PointCloud2::SharedPtr msg) {
...
void LidarFrontEnd::horizon_handler(const livox_ros_driver2::msg::CustomMsg::SharedPtr msg) {
...
void LidarFrontEnd::velo16_handler(const sensor_msgs::msg::PointCloud2::SharedPtr msg) {
    // TODO
}

void LidarFrontEnd::velo16_handler1(const sensor_msgs::msg::PointCloud2::SharedPtr msg) {
    // TODO
}
...
void LidarFrontEnd::oust64_handler(const sensor_msgs::msg::PointCloud2::SharedPtr msg) {
...
void
LidarFrontEnd::give_feature(pcl::PointCloud<PointType> &pl, vector<orgtype> &types, pcl::PointCloud<PointType> &pl_corn,
...
void
LidarFrontEnd::pub_func(pcl::PointCloud<PointType> &pl, rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr pub,
...
int LidarFrontEnd::plane_judge(const pcl::PointCloud<PointType> &pl, vector<orgtype> &types, uint i_cur, uint &i_nex,
...
bool
LidarFrontEnd::edge_jump_judge(const pcl::PointCloud<PointType> &pl, vector<orgtype> &types, uint i, Surround nor_dir) {
    if (nor_dir == 0) {
...
LidarFrontEnd::LidarFrontEnd() : rclcpp::Node("LiDAR_front_end") {
    ...
    switch (lidar_type) {
        case MID:
            printf("MID40\n");
            sub_points = this->create_subscription<sensor_msgs::msg::PointCloud2>("/livox/lidar", 1000, std::bind(
                    &LidarFrontEnd::mid_handler, this, std::placeholders::_1));
            break;

        case HORIZON:
            printf("HORIZON\n");
            sub_points_livox = this->create_subscription<livox_ros_driver2::msg::CustomMsg>("/livox/lidar", 1000, std::bind(
                    &LidarFrontEnd::horizon_handler, this, std::placeholders::_1));
            break;

        case VELO16:
            printf("VELO16\n");
            sub_points = this->create_subscription<sensor_msgs::msg::PointCloud2>("/velodyne_points", 1000, std::bind(
                    &LidarFrontEnd::velo16_handler, this, std::placeholders::_1));
            break;

        case OUST64:
            printf("OUST64\n");

            sub_points = this->create_subscription<sensor_msgs::msg::PointCloud2>("/os_cloud_node/points", 1000,
                                                                                  std::bind(
                                                                                          &LidarFrontEnd::oust64_handler,
    ...
    pub_full = this->create_publisher<sensor_msgs::msg::PointCloud2>("/laser_cloud", 100);
    pub_surf = this->create_publisher<sensor_msgs::msg::PointCloud2>("/laser_cloud_flat", 100);
    pub_corn = this->create_publisher<sensor_msgs::msg::PointCloud2>("/laser_cloud_sharp", 100);
